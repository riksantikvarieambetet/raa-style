...
module.exports = {
  ...
  theme: {
    ...
    fontSize: {
      ...
      'size-3': ['3rem', '3.05rem'],
      'size-2.5': ['2.5rem', '2.55rem'],
      'size-2.25': ['2.25rem', '2.30rem'],
      'size-2': ['2rem', '2.05rem'],
      'size-1.75': ['1.75rem', '1.8rem'],
      'size-1.625': ['1.625rem', '1.675rem'],
      'size-1.5': ['1.5rem', '1.55rem'],
      'size-1.375': ['1.375rem', '1.395rem'],
      'size-1.313': ['1.313rem', '1.333rem'],
      'size-1.125': ['1.125rem', '1.145rem'],
      'size-1': ['1rem', '1.05rem'],
      'size-0.813': ['0.813rem', '0.833rem'],
      'size-0.8125': ['0.8125rem', '0.8325rem'],
    },
    lineHeight: {
      none: '1rem',
      sm: '0.813rem',
