...
module.exports = {
  ...
  theme: {
    ...
    fontSize: {
      'size-3.75': ['3.75rem', '5.156rem'],
      'size-3': ['3rem', '4.125rem'],
      'size-2.5': ['2.5rem', '3.437rem'],
      'size-2.25': ['2.25rem', '3.094rem'],
      'size-2': ['2rem', '2.75rem'],
      'size-1.75': ['1.75rem', '2.406rem'],
      'size-1.625': ['1.625rem', '2.234rem'],
      'size-1.5': ['1.5rem', '2.0625rem'],
      'size-1.375': ['1.375rem', '1.890rem'],
      'size-1.313': ['1.313rem', '1.805rem'],
      'size-1.125': ['1.125rem', '1.547rem'],
